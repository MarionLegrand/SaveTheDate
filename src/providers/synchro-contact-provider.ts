...
export class SynchroContactProvider {
  ...
  */
  sendContactsDataToserver(tab: contactData[]): Observable<boolean> {
    ...
    return this.http.post('http://al2c.savethedate-al2c.fr/Al2cServer-war/webresources/contacts/creerContacts?token=' + Number(localStorage.getItem('token')), tab, header)
